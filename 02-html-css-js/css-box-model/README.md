...
- Implement CSS property-value pairs that influence the box model, such as `padding`, `margin`, and `border`.
...
Notice that `padding: 16px` adds padding to all four sides of the paragraph, displaying more of the background color.
